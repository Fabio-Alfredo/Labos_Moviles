package com.example.laboratorio_05.ui.Billboard
...
class BillBoard_Fragment : Fragment() {
    ...
    private fun listeners(){
        buttonFragmentNewMovie.setOnClickListener{
            it.findNavController().navigate(R.id.action_billBoard_Fragment_to_newMovie_Fragment)
        }

        cardViewFragmentStarWars.setOnClickListener{
            it.findNavController().navigate(R.id.action_billBoard_Fragment_to_movie_Fragment)
        }
    }
